...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'privatemessages_privatemessage', (
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pmsender', to=orm['users.User'])),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pmreceiver', to=orm['users.User'])),
        ))
        db.send_create_signal(u'privatemessages', ['PrivateMessage'])


    def backwards(self, orm):
        # Deleting model 'PrivateMessage'
        db.delete_table(u'privatemessages_privatemessage')
    ...
    models = {
        ...
        u'privatemessages.privatemessage': {
            'Meta': {'object_name': 'PrivateMessage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {'max_length': '3000'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pmreceiver'", 'to': u"orm['users.User']"}),
            'send_date': ('django.db.models.fields.DateTimeField', [], {}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pmsender'", 'to': u"orm['users.User']"})
        },
        u'users.user': {
