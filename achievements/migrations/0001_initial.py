...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        '''
            Do nothing. This migration was applied but the migration file was not created.
        '''
    ...
    models = {
        u'achievements.achievement': {
            ...
            'belongs_to': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['users.User']", 'symmetrical': 'False'}),
